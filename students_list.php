...
if ($course_result->num_rows > 0) {
    ...
    if (isset($_GET['course'])) {
        ...
        if ($student_result->num_rows > 0) {
            ...
            echo "<table border='1'>";
            echo "<tr><th>Имя</th><th>Фамилия</th><th>Телефонный номер</th><th>Email</th><th>Отчислить</th></tr>";
            while ($student_row = $student_result->fetch_assoc()) {
                ...
                echo "<td><form method='post'><input type='hidden' name='student_id' value='".$student_row["student_id"]."'><input type='hidden' name='selected_course' value='$selected_course'><input type='submit' name='dismiss_button' value='Отчислить'></form></td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
